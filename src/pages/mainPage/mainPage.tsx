...
import Book from "../../assets/ta_15.rar";
...
const MainPage: React.FC = () => {
  return (
    <div className={cx('container')}>
      ...
      <p className={cx('bottom-text')}>Джерело матеріалів для електронного посібника: М.С. Нікітченко, О.С. Шкільняк, С.С. Шкільняк. 
        <a href={Book} target="_blank" rel="noreferrer" download className={cx('bottom-text__link')}>Теорія алгоритмів: навчальний посібник</a>
        – Київ: Видавничо-поліграфічний центр "Київський університет", 2015. –241 с.
      </p>
    </div>
  );
};
